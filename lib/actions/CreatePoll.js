...
var CreatePoll = function (_Action) {
  _inherits(CreatePoll, _Action);

  function CreatePoll(name, creator) {
    ...
    if (!(options === undefined || Array.isArray(options) && options.every(function (item) {
      return typeof item === 'string';
    }))) {
      throw new TypeError('Value of optional argument "options" violates contract.\n\nExpected:\nArray<string>\n\nGot:\n' + _inspect(options));
    }

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CreatePoll).call(this));
